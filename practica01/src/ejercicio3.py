...
a  = [   0,     5,  p[2],   0,          0,          2,          2,    2]
al = [   0,     0,     0,  90,  90 + p[3],        180,        180,  180]
...
T2_2p=matriz_T(d[2],th[2],a[2],al[2])
T2p_3=matriz_T(d[3],th[3],a[3],al[3])
T3_4=matriz_T(d[4],th[4],a[4],al[4])
T4_51=matriz_T(d[5],th[5],a[5],al[5])
T4_52=matriz_T(d[6],th[6],a[6],al[6])
T4_ef=matriz_T(d[7],th[7],a[7],al[7])

T0_2=np.dot(T0_1,T1_2)
T0_2p=np.dot(T0_2,T2_2p)
T0_3=np.dot(T0_2p,T2p_3)
...
o2p_0 =np.dot(T0_2p, o2p_2p).tolist()
...
muestra_origenes([ o0_0, o1_0, o2_0, o3_0, o4_0,[ [o51_0], [o52_0] ] ], oef_0)
muestra_robot   ([ o0_0, o1_0, o2_0, o3_0, o4_0,[ [o51_0], [o52_0] ] ], oef_0)
input()
