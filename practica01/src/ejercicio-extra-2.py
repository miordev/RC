...
#         1           2      3          41          42     ee  
d  = [ p[0],          0,  p[2],          0,          0,    0 ]
th = [    0,  90 + p[1],     0,  90 + p[3],  90 - p[3],   90 ]
a  = [    0,          2,     0,          1,          1,    1 ]
al = [   90,         90,    90,        180,        180,  180 ]
...
T3_41=matriz_T(d[3],th[3],a[3],al[3])
T3_42=matriz_T(d[4],th[4],a[4],al[4])
T3_ee=matriz_T(d[5],th[5],a[5],al[5])

T0_2=np.dot(T0_1,T1_2)
T0_3=np.dot(T0_2,T2_3)
T0_41=np.dot(T0_3,T3_41)
T0_42=np.dot(T0_3,T3_42)
T0_ee=np.dot(T0_3,T3_ee)
...
oee_0 =np.dot(T0_ee, oee_ee).tolist()

# Mostrar resultado de la cinemática directa
muestra_origenes([ o0_0, o1_0, o2_0, o3_0, [ [o41_0], [o42_0] ] ], oee_0)
muestra_robot   ([ o0_0, o1_0, o2_0, o3_0, [ [o41_0], [o42_0] ] ], oee_0)
input()
