...
# Parámetros D-H:
#        0p   1     1p      2      3          41          42    ef 
d  = [    5,  2,     0,   - 2,     5,          0,          0,   0 ]
th = [ p[0],  0,  p[1],  - 90,  p[2],  90 - p[3],  90 + p[3],  90 ]
a  = [    0,  0,     3,     0,     0,          1,          1,   1 ]
al = [ - 90,  0,     0,  - 90,    90,         90,       - 90,  90 ]
...
T0_0p=matriz_T(d[0],th[0],a[0],al[0])
T0p_1=matriz_T(d[1],th[1],a[1],al[1])
T1_1p=matriz_T(d[2],th[2],a[2],al[2])
T1p_2=matriz_T(d[3],th[3],a[3],al[3])
...
T0_1=np.dot(T0_0p,T0p_1)
T0_1p=np.dot(T0_1,T1_1p)
T0_2=np.dot(T0_1p,T1p_2)
...
o0p_0 =np.dot(T0_0p, o0p_0p).tolist()
o1_0 =np.dot(T0_1, o1_1).tolist()
o1p_0 =np.dot(T0_1p, o1p_1p).tolist()
...
muestra_origenes([ o0_0, o0p_0, o1_0, o1p_0, o2_0, o3_0, [ [o41_0], [o42_0] ] ], oef_0)
muestra_robot   ([ o0_0, o0p_0, o1_0, o1p_0, o2_0, o3_0, [ [o41_0], [o42_0] ] ], oef_0)
input()
